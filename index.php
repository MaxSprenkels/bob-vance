...
<div tabindex="0" class="focus:outline-none">
            <div class="mx-auto container py-8">
                <div class="flex flex-wrap items-center lg:justify-between justify-center">
                    <div tabindex="0" class="focus:outline-none mx-2 w-72 xl:mb-0 mb-8">
                        <div>
                            <img alt="person capturing an image" src="https://www.expert.nl/media/frontend/catalog/products/372582717/630x630/372582717-6730760.jpg" tabindex="0" class="focus:outline-none w-full h-44" />
                        </div>
                        <div class="bg-white">
                    ...
                    <div tabindex="0" class="focus:outline-none mx-2 w-72 xl:mb-0 mb-8">
                        <div>
                            <img alt="person capturing an image" src="https://www.smeg.com/binaries/content/gallery/smeg-netherlands/fq60.png/fq60.png/brx%3AsquareMobile" tabindex="0" class="focus:outline-none w-full h-44" />
                        </div>
                        <div class="bg-white">
                            <div class="flex items-center justify-between px-4 pt-4">
                                <div>
                    ...
                    <div tabindex="0" class="focus:outline-none mx-2 w-72 xl:mb-0 mb-8">
                        <div>
                            <img alt="person capturing an image" src="https://www.smeg.com/binaries/content/gallery/smeg/categories/fab50rrdeu_doubledoor.jpg/fab50rrdeu_doubledoor.jpg/brx%3AsquareMobile" tabindex="0" class="focus:outline-none w-full h-44" />
                        </div>
                        <div class="bg-white">
                            <div class="flex items-center justify-between px-4 pt-4">
                                <div>
                    ...
                    <div tabindex="0" class="focus:outline-none mx-2 w-72 xl:mb-0 mb-8">
                        <div>
                            <img alt="person capturing an image" src="https://www.smeg.com/binaries/content/gallery/smeg/categories/orange_fridge_smeg.jpg/orange_fridge_smeg.jpg/brx%3AsquareMobile" tabindex="0" class="focus:outline-none w-full h-44" />
                        </div>
                        <div class="bg-white">
                            <div class="flex items-center justify-between px-4 pt-4">
                                <div>
        ...
        try {
            ...
            foreach ($koelkast as $koelkast) {
                echo "<tr><td>" . $koelkast["Naam"] ."</td>" . $koelkast["Prijs"] . "</td><td> <a href='add-fridge.php?id=" . $koelkast["id"] . "'>Toevoegen</td> </tr>";
            }
