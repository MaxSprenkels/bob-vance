...
<body>
    ...
    <!-- component -->
<div class="antialiased w-full h-full bg-gray-300 text-gray-400 font-inter p-10">
        ...
        >
          ...
          >
            <div id="title" class="w-full py-5 border-b border-gray-800">
              <h2 class="font-bold text-3xl text-white">Goedkoop</h2>
            ...
            <div id="content" class="">
              ...
              <div id="contain" class="leading-8 mb-10 text-lg font-light">
                <ul>
                  <li>Energie klasse C</li>
                  <li>Laag geluidsniveau</li>
                  <li>Flessenrek</li>
                  <li>Draairichting deur verwisselbaar</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          >
            <div id="title" class="w-full py-5 border-b border-gray-800">
              <h2 class="font-bold text-3xl text-white">Betrouwbaar</h2>
              <h3 class="font-normal text-indigo-500 text-xl mt-2">
              </h3>
            </div>
            <div id="content" class="">
